...
const Navbar = () => {
  const { input, setInput, handleSubmit, getBrowseCategories } =
  ...
  return (
    <>
      <div className="bg-black p-4 flex gap-2 items-center justify-between mb-2">
        <span>
          <svg
            role="img"
            viewBox="0 0 24 24"
            className="e-9640-logo e-9640-baseline"
            aria-label="Spotify"
            aria-hidden="false"
            height="36"
        ...
        <div className="flex gap-3 justify-center items-center">
          <span
            className="bg-[#282828] w-12 h-12 flex justify-center items-center rounded-full hover:cursor-pointer"
            onClick={() => navigate("/")}
          >
          ...
          >
            <input
              ...
              className="w-90 h-12 bg-[#2A2A2A] pl-13 rounded-l-full rounded-r-full text-white"
            />
            <button
              type="submit"
              className="h-6 w-6 absolute left-3 top-3 hover:cursor-pointer"
            >
              <IoSearch className="text-[lightgray] h-full w-full" />
            </button>
            <button
              className="h-6 w-6 absolute top-3 right-4 hover:cursor-pointer"
